  ...
  const businesses = [
    {
      ...
      mainCategory: "beauty_personal_care",
      subCategory: "hair_grooming",
      businessType: "barbershop",
      categoryDisplay: "Beauty, Salon & Barber",
      categoryDisplayRw: "Ubwiza, Saluni n'Ikinyozi",
      businessTypeDisplay: "Barbershop / Kinyozi",
      businessTypeDisplayRw: "Ikinyozi (Saluni y'Abagabo)",
    ...
    },
    {
      ...
      mainCategory: "fashion_apparel",
      subCategory: "tailoring_dressmaking",
      businessType: "dressmaker_couture",
      categoryDisplay: "Boutiques & Fashion",
      categoryDisplayRw: "Imyenda, Inkweto n'Imideri",
      businessTypeDisplay: "Dressmaker & Modern Couture",
      businessTypeDisplayRw: "Umudozi w'Imideri n'Imyenda y'Ubukwe",
    ...
    },
    {
      ...
      mainCategory: "repair_maintenance",
      subCategory: "electronics_repair",
      businessType: "phone_repair",
      categoryDisplay: "Repair & Maintenance",
      categoryDisplayRw: "Gukanika no Gusana",
      businessTypeDisplay: "Smartphone & Tablet Repair",
      businessTypeDisplayRw: "Gukora Telefoni na Tablette",
