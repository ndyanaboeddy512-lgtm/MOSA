        ...
        <div className="flex items-center justify-between h-16 sm:h-18">
          ...
          <div className="flex items-center gap-3 sm:gap-4">
            <Link href="/" className="flex items-center gap-2.5 group">
              {platformSettings.logoUrl ? (
                <img
                  ...
                  className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl object-contain bg-white p-0.5 border border-slate-200/80 shadow-xs group-hover:scale-105 transition-transform"
                />
              ) : (
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-tr from-emerald-800 via-emerald-700 to-amber-500 flex items-center justify-center text-white font-extrabold text-xl shadow-xs group-hover:scale-105 transition-transform">
                  {platformSettings.platformName ? platformSettings.platformName.charAt(0) : "M"}
                </div>
              )}
              <div className="flex flex-col">
                <span className="font-extrabold text-lg sm:text-xl tracking-tight text-slate-950 leading-none">
            ...
            <button
              ...
              className="hidden md:flex items-center gap-2 px-3 py-1.5 text-xs font-semibold text-slate-800 bg-slate-50 hover:bg-slate-100 border border-slate-200/80 rounded-full transition-all shadow-xs group"
            ...
            >
              ...
              <span className="text-slate-900 font-medium">{displayLabel}</span>
            ...
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  key={link.href}
                  href={link.href}
                  className={`flex items-center gap-1.5 px-3.5 py-2 rounded-full text-xs font-semibold uppercase tracking-wider transition-all ${
                    isActive
              ...
              <Link
                ...
                className={`flex items-center gap-1.5 px-3.5 py-2 rounded-full text-xs font-semibold uppercase tracking-wider transition-all ${
                  pathname.startsWith(activePortal.href)
                    ...
                    : "text-amber-900 bg-amber-50 border border-amber-200/70 hover:bg-amber-100/60"
                }`}
              >
                <activePortal.icon className="w-3.5 h-3.5 text-amber-700" />
          ...
          <div className="flex items-center gap-1.5 sm:gap-2.5">
            ...
            <Link
              ...
              className="hidden md:flex items-center gap-1.5 px-4 py-2 text-xs font-bold text-white bg-slate-950 hover:bg-slate-800 rounded-full shadow-xs hover:scale-[1.02] transition-all"
